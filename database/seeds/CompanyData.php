...
class CompanyData extends Seeder
{
    ...
    public function run()
    {
        Company::insert([
            ...
            ['code' => 'MNG', 'name' => 'MNGoodHealth Inc.', 'address' => 'First Capitol Place First Cor. Philam Sts. Kapitolyo, Pasig City', 'tel' => '6370635'],
            ...
            ['code' => 'SOFI', 'name' => 'Serbisyo Outsourcing Facilities Inc', 'address' => 'First Capitol Place First Cor. Philam Sts. Kapitolyo, Pasig City', 'tel' => '6370635'],
        ]);
    }
}
